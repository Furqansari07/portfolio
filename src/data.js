export const BOOT_LINES = [
  "$ whoami",
  "furqan_ansari — full_stack_software_engineer",
  "$ status --check",
  "availability: open_to_work | notice_period: immediate_joiner",
];
...
export const EXPERIENCE = [
  {
    ...
    points: [
      "Cut backend response time 40% by indexing 1,000+ record queries",
      "Shipped 5+ responsive apps for 50+ NGO users (HTML5, PHP, React.js)",
      "Resolved 15+ production issues, held 98% code quality standard",
    ],
    stack: ["React.js", "PHP", "MySQL", "Git", "Node.js"],
  },
  {
    hash: "7c1b840",
    ...
    points: [
      "Integrated 5+ REST APIs at 99.5% reliability in production",
...
export const PROJECTS = [
  {
    ...
    metrics: ["95+ lighthouse", "500+ req/day", "1,000+ records"],
    stack: ["React.js", "PHP", "MySQL", "HTML", "CSS", "JavaScript"],
    href: "https://recipe-finder-oiq7.vercel.app/",
  },
  {
    name: "Virtual Meet Summarizer",
    status: "live",
    desc: "NLP-powered tool converting speech to text at 95% accuracy, condensing 60-min meetings into 2–3 min summaries at 97% retention.",
    metrics: ["95% accuracy", "97% retention", "80% time saved"],
    stack: ["Python", "Flask", "MongoDB", "NLP"],
    href: "https://virtual-meet-summarizer.vercel.app/",
  },
  {
    name: "Quiz Hub",
    status: "live",
    desc: "Responsive quiz app with dynamic API-driven questions, dark mode, and multiple auth options.",
    metrics: ["dynamic api", "dark mode"],
...
export const SOFT_SKILLS = [
  ...
  "Adaptability", "Time Management", "Ownership", "Analytical Thinking",
];
...
export const OTHER_BUILDS = [
  ...
  { name: "Calculator", desc: "Basic arithmetic calculator", stack: ["HTML", "CSS", "JS"], href: "https://calculator-two-lake-79.vercel.app/" },
...
export const EDUCATION = [
  {
    ...
    school: "M. H. Saboo Siddik College of Engineering, Mumbai University",
    date: "2021 – 2025",
    highlight: "9.14",
    highlightLabel: "CGPA / 10 · Top 5% of Batch",
  },
  {
    degree: "Class XII",
